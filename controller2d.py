...
class Controller2D(object):
    ...
    def update_controls(self):
        ...
        if self._start_control_loop:
            ...
            v_error = v_desired - v
            v_integral = self.vars.integral_error_previous + v_error * sample_time
            v_derivative = (v_error - self.vars.error_previous) / sample_time
            a = kp * v_error + ki * v_integral + kd * v_derivative
            throttle_output = a
        ...
        self.vars.error_previous = v_error
        self.vars.integral_error_previous = v_integral